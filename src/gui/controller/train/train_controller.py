...
class TrainController:
    ...
    # @staticmethod
    # def _prepare_model(f_train, l_train, has_normalization=True, epochs=EPOCHS_DEFAULT):
    #     return Model(f_train, l_train, has_normalization, epochs)

    # @staticmethod
    # def _prepare_classifier(model):
    #     return Classifier(model.model)
    #
    # @staticmethod
    # def _evaluate_classifier_efficiency(classifier, f_test, l_test):
