...
if __name__ == '__main__':
    ...
    # for _a in a:
    #     f.plot_confusion_matrix(np.asarray(_a), ['AWAKE', 'REM', 'NREM'], normalize=True)
    print(test_case.case_pyeeg_9())
    # f._prepare_plot_confusion_matrix(np.asarray(a0), ['AWAKE', 'REM', 'NREM'], normalize=True)
    # f.plot_confusion_matrix(np.asarray(a0), ['AWAKE', 'REM', 'NREM'], normalize=False)
